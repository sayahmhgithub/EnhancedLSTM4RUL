#-----------------------------------------------------------------------------------------------
# Python on spider programming tool
#-----------------------------------------------------------------------------------------------
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#-----------------------------------------------------------------------------------------------
"""
Created on Thu Apr 23 10:51:25 2018-2019 and Revised 2019-2020.
@author: Djillali Guebli
@Supervisor : Mohamed Sayah 
"""
#-----------------------------------------------------------------------------------------------
import pandas as pd
import numpy as np
...
# For each data sets FD00x, the data file x is considered.
# for FD001, x is equal to 1 and the file variable is set to 1.
file=1 
#-----------------------------------------------------------------------------------------------
...
if file==4:
    look_back=19
train = pd.read_csv(Home-Directory/train_FD00 + str(file) + '.txt', sep=" ", header=None)
test = pd.read_csv(Home-Directory/test_FD00 + str(file) + '.txt', sep=" ", header=None)
rul= pd.read_csv(Home-Directory/RUL_FD00 + str(file) + '.txt', sep=" ", header=None)
...
rul.columns=['rul']
#-----------------------------------------------------------------------------------------------
#The sensors s1, s5, s10, s16, s18, and s19 as well as op_setting 3, will  be removed bc they have no effects  (min=max)
#-----------------------------------------------------------------------------------------------
# The distribution of the columns : Establishing remaining life in cycles
#-----------------------------------------------------------------------------------------------
